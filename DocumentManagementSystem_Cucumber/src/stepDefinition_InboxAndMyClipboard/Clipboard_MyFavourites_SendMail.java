...
public class Clipboard_MyFavourites_SendMail {
WebDriver driver;	
	
	@Given("^My Clipboard module module, checkbox to select the document, Mail link on the favourite grid$")
	public void My_Clipboard_module_module_checkbox_to_select_the_document_Mail_link_on_the_favourite_grid() throws Throwable {
	...
	public void Navigate_to_favourite_page_select_the_required_file_click_on_mail_link_provide_the_email_ids_and_click_on_Send_button_in_favourite_page() throws Throwable {
	...
	public void Email_should_sent_to_the_respective_email_id_successfully_from_favourite_page() throws Throwable {
