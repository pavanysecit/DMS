...
public class Inbox_SendMail {
WebDriver driver;	
	
	@Given("^Inbox module, checkbox to select the document, Mail link on the Inbox grid$")
	public void Inbox_module_checkbox_to_select_the_document_Mail_link_on_the_Inbox_grid() throws Throwable {
	...
	public void Navigate_to_Inbox_page_select_the_required_file_click_on_mail_link_provide_the_email_ids_and_click_on_Send_button() throws Throwable {
	...
	public void Email_should_sent_to_the_respective_email_id_successfuly() throws Throwable {
