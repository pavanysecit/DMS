...
public class Inbox_RightClick_MoveDocument_ToDepartment {
WebDriver driver;	
	
	@Given("^Inbox module, MoveTo link on right click and department folder$")
	public void Inbox_module_MoveTo_link_on_right_click_and_department_folder() throws Throwable {
	...
	public void Navigate_to_Inbox_page_right_click_on_any_document_and_click_on_MoveTo_link_right_click_on_required_department_folder_and_click_on_paste_link() throws Throwable {
	...
	public void Document_should_get_moved_from_Inbox_to_other_department_folder_using_right_click_MoveTo_option() throws Throwable {
	    driver.quit();
	}
}