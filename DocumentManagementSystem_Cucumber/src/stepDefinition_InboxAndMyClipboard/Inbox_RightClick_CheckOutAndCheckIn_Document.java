...
public class Inbox_RightClick_CheckOutAndCheckIn_Document {
WebDriver driver;	
	
	@Given("^Inbox module, Right click, check-out and check-in link$")
	public void Inbox_module_Right_click_check_out_and_check_in_link() throws Throwable {
	...
	public void Navigate_to_Inbox_page_right_click_on_any_document_click_on_check_out_link_and_check_in_link() throws Throwable {
	...
	public void Clicking_on_check_out_link_document_should_get_opened_and_click_of_check_in_changes_done_in_the_document_should_get_saved_in_the_inbox_page() throws Throwable {
