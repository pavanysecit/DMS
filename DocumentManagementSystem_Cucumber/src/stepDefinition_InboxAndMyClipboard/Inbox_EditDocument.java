...
public class Inbox_EditDocument {
WebDriver driver;	
	
	@Given("^Inbox module, checkbox to select the document and edit link on the Inbox grid$")
	public void Inbox_module_checkbox_to_select_the_document_and_edit_link_on_the_Inbox_grid() throws Throwable {
	...
	public void Navigate_to_Inbox_page_select_the_required_file_click_on_edit_link_change_the_details_and_click_on_update_button() throws Throwable {
	...
	public void System_should_allow_user_to_change_the_details_from_inbox_page_and_changes_should_get_reflected_for_that_document() throws Throwable {
	    driver.quit();
	}
}