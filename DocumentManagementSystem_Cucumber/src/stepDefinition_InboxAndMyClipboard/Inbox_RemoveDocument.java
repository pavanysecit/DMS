...
public class Inbox_RemoveDocument {
WebDriver driver;	
	
	@Given("^Inbox module, uploaded document and Remove link$")
	public void Inbox_module_uploaded_document_and_Remove_link() throws Throwable {
	...
	public void Navigate_to_Inbox_page_select_the_document_and_click_on_Remove_link() throws Throwable {
	...
	public void Uploaded_document_should_get_removed_successfully_and_should_not_display_in_the_inbox_list() throws Throwable {
