...
public class ViewMenuBar_FileDetails_ViewFileInformation_Validation {
WebDriver driver;	
	
	@Given("^View Menu controls, File Details menu control and validation message$")
	public void View_Menu_controls_File_Details_menu_control_and_validation_message() throws Throwable {
	...
	public void Click_on_Inbox_link_dont_select_the_document_checkbox_Click_on_View_menu_control_and_click_on_file_details_link() throws Throwable {
	...
	public void System_should_display_validation_message_for_not_selecting_the_document_checkbox_and_clicking_on_file_details_link() throws Throwable {
