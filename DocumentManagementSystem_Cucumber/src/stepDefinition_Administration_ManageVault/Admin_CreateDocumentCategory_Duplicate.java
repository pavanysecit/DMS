...
public class Admin_CreateDocumentCategory_Duplicate {
WebDriver driver;	
	
	@Given("^admin module, document category creation page and duplicate document category details$")
	public void admin_module_document_category_creation_page_and_duplicate_document_category_details() throws Throwable {
	...
	public void Click_on_add_document_category_link_fill_the_existing_document_category_details_and_click_on_save_button() throws Throwable {
	...
	public void Document_category_should_not_get_created_successfuylly_and_should_display_error_message() throws Throwable {
		...
		String expectedText = "Document Category already exists.";
