...
public class Admin_CreateLocation_PageNavigation {
WebDriver driver;	
	...
	public void Navigate_to_location_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_location_pages_when_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}