...
public class Admin_CreateDocumentCategory_PageNavigation {
WebDriver driver;	
	
	@Given("^admin module, next and last buttons in document category page$")
	public void admin_module_next_and_last_buttons_in_document_category_page() throws Throwable {
	...
	public void Navigate_to_document_category_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_document_category_pages_when_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}