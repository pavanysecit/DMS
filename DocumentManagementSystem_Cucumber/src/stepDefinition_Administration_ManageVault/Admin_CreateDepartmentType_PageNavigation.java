...
public class Admin_CreateDepartmentType_PageNavigation {
WebDriver driver;	
	
	@Given("^admin module, next and last buttons in document type page$")
	public void admin_module_next_and_last_buttons_in_document_type_page() throws Throwable {
	...
	public void Navigate_to_document_type_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_document_type_pages_when_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}