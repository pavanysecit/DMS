...
public class Admin_CreateCompany_PageNavigation {
WebDriver driver;	
	
	@Given("^admin module, next and last buttons in company page$")
	public void admin_module_next_and_last_buttons_in_company_page() throws Throwable {
	...
	public void Navigate_to_company_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_company_pages_when_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}