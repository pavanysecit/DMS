...
public class Admin_CreateDepartment_PageNavigation {
WebDriver driver;	
	
	@Given("^admin module, next and last buttons in department page$")
	public void admin_module_next_and_last_buttons_in_department_page() throws Throwable {
	...
	public void Navigate_to_department_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_department_pages_when_click_on_next_button() throws Throwable {
		driver.quit();
	}
}