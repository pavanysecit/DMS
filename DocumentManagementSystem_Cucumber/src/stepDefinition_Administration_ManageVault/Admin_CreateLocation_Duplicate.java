...
public class Admin_CreateLocation_Duplicate {
WebDriver driver;	
	
	@Given("^admin module, location creation page and duplicate location details$")
	public void admin_module_location_creation_page_and_duplicate_location_details() throws Throwable {
	...
	public void Click_on_add_location_link_fill_the_existing_location_details_and_click_on_save_button() throws Throwable {
	...
	public void Location_should_not_get_created_successfuylly_and_should_display_error_message() throws Throwable {
		...
		String expectedText = "Location is already exist!";
