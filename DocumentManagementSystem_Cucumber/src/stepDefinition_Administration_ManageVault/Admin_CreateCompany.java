...
public class Admin_CreateCompany {
WebDriver driver;	
	
	@Given("^admin module, company creation page$")
	public void admin_module_company_creation_page() throws Throwable {
	...
	public void Click_on_add_company_link_fill_the_details_and_click_on_save_button() throws Throwable {
	...
	public void company_should_get_created_successfuylly_and_should_be_visible_in_the_company_list() throws Throwable {
		...
		String expectedText = "Company Added successfully.";
