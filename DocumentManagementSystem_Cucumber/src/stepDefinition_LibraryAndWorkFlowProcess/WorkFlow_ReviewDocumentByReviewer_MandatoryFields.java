...
public class WorkFlow_ReviewDocumentByReviewer_MandatoryFields {
WebDriver driver;	
	
	@Given("^My tasks under reviews & approval module, document, submit review button and submit button$")
	public void My_tasks_under_reviews_approval_module_document_submit_review_button_and_submit_button() throws Throwable {
	...
	public void Navigate_to_Reviews_Approval_module_click_on_My_tasks_right_click_on_document_click_on_Submit_Review_button_and_submit_button() throws Throwable {
	...
	public void Mandatory_message_should_be_displayed_if_the_user_doesn_t_select_the_status_and_click_on_submit_button() throws Throwable {
