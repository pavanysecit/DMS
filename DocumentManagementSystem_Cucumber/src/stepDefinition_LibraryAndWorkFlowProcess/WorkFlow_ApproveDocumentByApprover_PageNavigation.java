...
public class WorkFlow_ApproveDocumentByApprover_PageNavigation {
WebDriver driver;
	
	@Given("^My tasks under reviews & approval module, next and last buttons in approver workflow page$")
	public void My_tasks_under_reviews_approval_module_next_and_last_buttons_in_approver_workflow_page() throws Throwable {
	...
	public void Navigate_to_Reviews_Approval_module_click_on_My_tasks_and_click_on_Next_Last_buttons_in_approver_workflow_page() throws Throwable {
	...
	public void System_should_navigate_to_different_pages_when_approver_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}