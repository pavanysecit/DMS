...
public class UserManagement_CreateUser_PageNavigation {
WebDriver driver;	
	
	@Given("^Admin module, next and last buttons in User page$")
	public void Admin_module_next_and_last_buttons_in_User_page() throws Throwable {
	...
	public void Navigate_to_user_pages_and_click_on_Next_Last_buttons() throws Throwable {
	...
	public void System_should_navigate_to_different_user_pages_when_click_on_next_button() throws Throwable {
	    driver.quit();
	}
}