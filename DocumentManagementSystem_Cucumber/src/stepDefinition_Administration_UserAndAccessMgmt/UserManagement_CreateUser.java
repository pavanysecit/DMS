...
public class UserManagement_CreateUser {
WebDriver driver;	
	
	@Given("^Admin module, user management section and user creation page$")
	public void Admin_module_user_management_section_and_user_creation_page() throws Throwable {
	...
	public void Click_on_User_management_link_fill_the_user_details_and_click_on_save_button() throws Throwable {
	...
	public void User_should_get_created_successfully_and_confirmation_messages_should_be_displayed() throws Throwable {
